...
//////////////////////// convert to arabic //////////////
const homeArabic = document.querySelector('.home-p-arabic');
const homeEnglish = document.querySelector('.home-p');
const converter = document.getElementById('arabic');
const converterE = document.getElementById('english');
arabic.addEventListener('click', changeToArabic);
converterE.addEventListener('click', changeToEnglish);

function changeToArabic() {
    homeArabic.style.display = 'block';
    homeEnglish.style.display = 'none';
}

function changeToEnglish() {
    homeArabic.style.display = 'none';
    homeEnglish.style.display = 'block';
}
